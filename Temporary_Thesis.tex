...
\usepackage[bf]{caption} % caption: FIG in bold, 1.5 line spacing in figure and table captions
\captionsetup{font={small,singlespacing}, width=0.9\textwidth}
...
\newcommand{\numberedchapter}[1]{ % Preparation for numbered chapters
...
\newcommand{\unnumberedchapterNOTOC}[1]{ % Preparation for unnumbered chapters
    	\cleardoublepage % To make sure the previous headers are passed
    	\addcontentsline{toc}{chapter}{#1} % Also adds the chapter name to the Contents
    	\lhead{\bfseries #1}}% Header
...
%\input{Preamble/quotation}
\input{Preamble/License_Copyright}

%----------------------------------------------------------------------------------------
%	LIST OF CONTENTS/FIGURES/TABLES
%----------------------------------------------------------------------------------------

\unnumberedchapterNOTOC{Contents}
...
%\introfalse
\ifintro
    \numberedchapter{Introduction} % Title of the unnumbered chapter
        %\chapter{Introduction}
        \input{MainText/ch1_intro/introduction} % Introduction (unnumbered)
\fi
...
%\litrevfalse
\iflitrev
    \numberedchapter{Background}\label{chp:background}
    %\chapter{Literature review}
        %\input{MainText/ch1_litrev/litrev_intro} % Import your chapters here
        \input{MainText/ch2_litrev/litrev_coldatoms} % Import your chapters here
        \input{MainText/ch2_litrev/litrev_superfluids} % Import your chapters here
        %\input{MainText/ch1_litrev/litrev_numerics} % Import your chapters here
        %\input{MainText/ch1_litrev/litrev_chaos} % Import your chapters here
        %\input{MainText/ch1_litrev/litrev_prelim} % Import your chapters here
\fi
...
%\numericsfalse
\ifnumerics
    \numberedchapter{Numerical methods}
    %\chapter{Numerics}
        \input{MainText/ch3_numerics/num_splitop}
        \input{MainText/ch3_numerics/num_gpgpu}
        \input{MainText/ch3_numerics/num_stirap}
        \input{MainText/ch3_numerics/num_gpue}
        %\input{MainText/ch3_numerics/num_bogo}

    %\input{MainText/ch2_numerics/num_errors}
\fi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifvtxdyn
\vtxdyntrue
...
\ifvtxdyn
    ...
    %\chapter{Bose--Einstein condensate dynamics}
        \input{MainText/ch4_vort/vort_lattice}
    \fi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifmoire
\moiretrue
...
\ifmoire
    ...
    %\chapter{Moir\'e superlattice structures}
        \input{MainText/ch5_kickit/kickit_moire}
\fi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifdefect
\defecttrue
...
\ifdefect
    ...
    %\chapter{Defect engineering}
        %\input{MainText/ch6_phasegineer/phasegineer_dislocate}
        \input{MainText/ch6_phasegineer/ch6_phasegineer4}
        %\input{MainText/ch6_phasegineer/ch6_delaunay_voronoi}
...
%\concfalse
\ifconc
    \numberedchapter{Conclusions and outlook} % Title of the unnumbered chapter
    %\chapter{Conclusion} % Title of the unnumbered chapter
        \input{MainText/ch7_disclusions/conclusion}% Conclusion (unnumbered)
\fi
%----------------------------------------------------------------------------------------
%	APPENDICES
%----------------------------------------------------------------------------------------
...
%\input{MainText/Appendices/num_bogo}
...
\bibliography{Preamble/MLXD_LIB_URL_FIN_POSTEXAM} % The references information are stored in the file named "Thesis_bibliography.bib"
...
\includepdf[pages=-, offset=0.54cm \voffset]{./Images/papers/paper1.pdf}
\includepdf[pages=-, offset=0.54cm \voffset]{./Images/papers/paper2.pdf}
\includepdf[pages=-, offset=0.54cm \voffset]{./Images/papers/paper3.pdf}
