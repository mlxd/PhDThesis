...
\litrevtrue
\iflitrev
    \numberedchapter{Literature review}
...
\ifnumerics
    ...
    %\chapter{Numerics}
        ...
        \input{MainText/ch3_numerics/ch3_afterstirap}
...
\vtxdyntrue
\ifvtxdyn
    \numberedchapter{Bose--Einstein condensate dynamics}
...
\defecttrue
\ifdefect
    \numberedchapter{Defect engineering}
    %\chapter{Defect engineering}
        %\input{MainText/ch6_phasegineer/phasegineer_dislocate}
        \input{MainText/ch6_phasegineer/ch6_phasegineer2}
...
\conctrue
\ifconc
    \numberedchapter{Conclusion} % Title of the unnumbered chapter
