...
\iflitrev
    \chapter{Literature review}
        ...
        \input{MainText/ch1_litrev/litrev_coldatoms} % Import your chapters here
        \input{MainText/ch1_litrev/litrev_superfluids} % Import your chapters here
...
\ifnumerics
    \chapter{Numerics}
        \input{MainText/ch2_numerics/num_splitop}
        \input{MainText/ch2_numerics/num_gpgpu}
        \input{MainText/ch2_numerics/Arxiv_Resub}
        \input{MainText/ch2_numerics/num_gpue}
        \input{MainText/ch2_numerics/num_bogo}
...
\vtxdyntrue
\ifvtxdyn
    \chapter{Bose-Eisntein condensate dynamics}
        \input{MainText/ch3_vort/vort_lattice}
    \fi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifmoire
\moiretrue
\ifmoire
    \chapter{Moir\'e superlattice structures}
        \input{MainText/ch4_kickit/kickit_moire}
\fi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifdefect
\defecttrue
\ifdefect
    \chapter{Defect engineering}
        \input{MainText/ch5_phasegineer/phasegineer_dislocate}
\fi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
