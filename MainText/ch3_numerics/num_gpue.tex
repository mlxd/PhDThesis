...
An example of the density of the groundstate and the associated wavefunction phase at a rotation frequency of $\Omega = 0.995\omega_x$ is given in Fig.~\ref{fig:showingoff} at a resolution of $2^{11}\times 2^{11}$ ($2048\times 2048$). Although aliasing may be apparent in the phase, this is due to the limited resolution of the computer monitor (printer). The presence of a well ordered Abrikosov lattice is clearly visible.
