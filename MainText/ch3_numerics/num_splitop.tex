...
The error can be further reduced through the use of 2nd order Strang splitting~\cite{SIAM J. Numer. Anal., 46(1), 103–123. (21 pages) }, taking the error in the numerical integration scheme to $\mathcal{O}(\tau^3)$, with the resulting operator implementation given as
