...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.7\textwidth,]{ch2_numerics/GPUEvsTS.png}
...
\begin{figure}[h]
    \centering
        \includegraphics[height=\textwidth,angle=270]{ch2_numerics/GPUE_Seq1}
    \caption{Simplified combined sequence and state diagram for GPUE operation (1 of 2).}
    \label{fig:gpue_seq}
\end{figure}
\begin{figure}[h]
    \centering
        \includegraphics[height=\textwidth,angle=270]{ch2_numerics/GPUE_Seq2}
