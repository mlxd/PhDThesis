...
\begin{figure}[H] \centering
    \includegraphics[width=0.85\textwidth]{ch6_phasegineer/imgs/NEWPICS/1vtx_remove1_centred2}
...
\begin{figure}[H] \centering
    \includegraphics[width=0.85\textwidth]{ch6_phasegineer/tikz/EKt}
...
\begin{figure}[H] \centering
    \includegraphics[width=0.85\textwidth]{ch6_phasegineer/imgs/1vtx_remove1_uncentred}
...
\begin{figure}
    \includegraphics[width=0.85\textwidth, trim=0mm 0 0 0]{ch6_phasegineer/imgs/g2d/varr_161/Trajectory}
...
\begin{figure}[H] \centering
    \includegraphics[width=0.85\textwidth]{ch6_phasegineer/imgs/NEWPICS/g6_varr0_varr161}
...
\begin{figure}[H] \centering
    \includegraphics[width=0.85\textwidth]{./ch6_phasegineer/imgs/NEWPICS/Delaunay_varr161.pdf}
...
\begin{figure}[H] \centering
    \includegraphics[width=0.85\textwidth]{ch6_phasegineer/imgs/NEWPICS/arc_def57.pdf}
...
\begin{figure}[H] \centering
    \includegraphics[width=0.85\textwidth,trim=0mm 0 0 0]{ch6_phasegineer/imgs/NEWPICS/Trajectory2edge.png}
...
\begin{figure}[H] \centering
    \includegraphics[width=0.85\textwidth]{ch6_phasegineer/imgs/NEWPICS/2edge_Defect57_t}
...
\begin{figure}[H] \centering
    \vspace{1cm}
    \includegraphics[width=0.85\textwidth]{ch6_phasegineer/imgs/NEWPICS/Defect57_varr161anti.pdf}
...
\begin{figure}[H] \centering
    %\vspace{1cm}
    \includegraphics[width=0.85\textwidth]{ch6_phasegineer/imgs/NEWPICS/Defect57_nuclear.pdf}
...
\begin{figure}[H] \centering
    %\vspace{1cm}
    \includegraphics[width=0.85\textwidth]{ch6_phasegineer/imgs/NEWPICS/g6_2edge_anti_nuclear.pdf}
