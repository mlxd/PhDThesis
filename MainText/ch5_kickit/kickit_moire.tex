...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.8\textwidth, angle=0, trim=0 0 0 0]{ch5_kickit/fig1}
...
\begin{figure}[tb]
    ...
    \centering
    \includegraphics[width=0.75\textwidth]{ch5_kickit/EKcEKi_kick_dt2}
...
\begin{figure}[tb]
	...
	\includegraphics[width=0.75\textwidth]{ch5_kickit/fig3}
...
\subsection{Rapidly rotating condensate}
	...
	\begin{figure}[tb]
        \centering
			\includegraphics[width=0.75\textwidth]{ch5_kickit/fig4}
	...
	\begin{figure}[bt]
        \centering
		\includegraphics[width=0.75\textwidth]{ch5_kickit/fig5}
...
\begin{figure}[tb]
	...
	\includegraphics[width=0.75\textwidth]{ch5_kickit/Moire_lattice_BEC_HigherK_lambda}
...
\begin{figure}[tb]
	...
	\includegraphics[width=0.75\textwidth]{ch5_kickit/fig6}
...
\end{figure}
	...
	\begin{figure}[tb]
        \centering
		\includegraphics[width=0.75\textwidth]{ch5_kickit/fig7}
    ...
    \begin{figure}[tb]
        \centering
        \includegraphics[width=0.75\textwidth]{ch5_kickit/theta_sweep_diff}
...
\begin{figure}[tb]
    \centering
	\includegraphics[width=0.75\textwidth]{ch5_kickit/fig8}
