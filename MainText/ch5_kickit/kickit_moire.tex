...
\begin{figure}
    ...
    \includegraphics[width=0.48\textwidth]{ch5_kickit/HigherK_edit}
    %\includegraphics[width=0.48\textwidth]{ch5_kickit/HigherK_k}
    %\includegraphics[width=0.48\textwidth]{ch5_kickit/HigherK_lambda}
    \includegraphics[width=0.48\textwidth]{ch5_kickit/HigherK_moire_edit}
