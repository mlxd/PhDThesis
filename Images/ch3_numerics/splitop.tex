...
\begin{tikzpicture}[node distance = 2.5cm, auto, scale=1, transform shape]
    ...
    \node [left of=wfcr1, node distance = 4.5cm] (num1) {$(1)$};
    ...
    \node [left of=wfcr3, node distance = 2cm] (num2) {$(2)$};
    ...
    \node [left of=wfcr4, node distance = 2cm] (num2) {$(3)$};
    ...
    \node [left of=wfcrfin, node distance = 4.5cm] (num4) {$(4)$};
